...
from datasetHandling.LiveDataHandling.loadLiveData import loadLiveCaptureData
from datasetHandling.datasetPreprocess import preprocess_dataset, preprocess_AC_dataset, preprocess_live_dataset
...
def datasetLoadProcess(dataset_used, dataset_preprocessing):
    ...
    if dataset_used == "CICIOT":
        ...
        # Load CICIOT data
        ciciot_train_data, ciciot_test_data, irrelevant_features_ciciot = loadCICIOT(train_sample_size=80, test_sample_size=20,
               training_dataset_size=600000, testing_dataset_size=120000, attack_eval_samples_ratio=0.3)
