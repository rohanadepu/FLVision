...
from hflClientModelTrainingConfig.AC_DiscModelClientConfig import ACDiscriminatorClient
...
def main():
    print("\n ////////////////////////////// \n")
    print("Federated Learning AC Discriminator Training:", "\n")
    ...
    client = ACDiscriminatorClient(discriminator, X_train_data, X_val_data, y_train_categorical,
                          y_val_categorical, X_test_data, y_test_categorical, BATCH_SIZE,
