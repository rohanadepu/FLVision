...
def main():
    print("\n ////////////////////////////// \n")
    print("Stand Alone Transfer Discriminator Training:", "\n")
    ...
    intrusion_client = DiscriminatorIntrusionTraining(discriminator, generator, X_train_data, X_val_data, y_train_data, y_val_data,
                                                      X_test_data, y_test_data, BATCH_SIZE, noise_dim, epochs, steps_per_epoch,
                                                      dataset_used)

    intrusion_client.fit()
    intrusion_client.evaluate()

    synthetic_client = DiscriminatorSyntheticTraining(discriminator, generator, X_train_data, X_val_data, y_train_data, y_val_data,
                                                      X_test_data, y_test_data, BATCH_SIZE, noise_dim, epochs, steps_per_epoch,
                                                      dataset_used)

    synthetic_client.fit()
